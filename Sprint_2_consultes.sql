...
/*=================================================================================
Exercici 5 La secció de màrqueting desitja tenir accés a informació específica 
...
=====================================================================
 ...
 S'ha eliminat del flux principal d'execució la normalització 
dels tipus de dades (alineació entre claus primàries i foranes) 
amb l'objectiu de garantir que l'script es pugui executar de manera 
contínua i sense interrupcions durant la correcció.
Tot i això, aquestes modificacions sí que s'han realitzat i documentat 
a l'informe, incloent el codi SQL corresponent i l'explicació del 
procés seguit.
